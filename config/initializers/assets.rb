...
Rails.application.config.assets.precompile += %w[ controllers/tree_controller.js ]
Rails.application.config.assets.precompile += %w[ DefaultArtistPfp.png ]
Rails.application.config.assets.precompile += %w[ controllers/hourly_listening_controller.js ]
Rails.application.config.assets.precompile += %w[ controllers/streamgraph_controller.js ]
Rails.application.config.assets.precompile += %w[ controllers/daily_listening_controller.js ]
