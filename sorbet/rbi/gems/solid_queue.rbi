...
module SolidQueue
  ...
  def logger; end
  def logger=(val); end
  def on_dispatcher_start(*, **, &); end
  def on_dispatcher_stop(*, **, &); end
  def on_scheduler_start(*, **, &); end
  def on_scheduler_stop(*, **, &); end
  def on_start(&); end
  def on_stop(&); end
  def on_thread_error; end
  def on_thread_error=(val); end
  def on_worker_start(*, **, &); end
  def on_worker_stop(*, **, &); end
...
class SolidQueue::ClaimedExecution::Result < Anonymous_Struct_53
  def success?; end
end
