...
class Capybara::SessionConfig
  ...
  def default_retry_interval=(arg0); end
...
module Capybara::Node::Matchers
  ...
  def has_element?(locator = nil, **options, &optional_filter_block); end
  ...
  def has_no_element?(locator = nil, **options, &optional_filter_block); end
...
class Capybara::RackTest::Browser
  ...
  def submit(method, path, attributes, content_type: nil); end
  def title; end
  def visit(path, **attributes); end
...
class Capybara::Selenium::Node < Capybara::Driver::Node
  ...
  def disabled?; end
  def double_click(keys = nil, **options); end
  def drag_to(element, drop_modifiers: nil, **); end
  def drop(*_); end
