...
#
#   https://github.com/sorbet/sorbet-typed/new/master?filename=lib/vips/all/vips.rbi
#
# vips-8.15.1
...
module Vips
  ...
  def self.cache_drop_all; end
  def self.cache_max; end
  def self.cache_max_files; end
  def self.cache_max_mem; end
  def self.cache_print; end
  ...
  def self.tracked_allocs; end
  def self.tracked_files; end
  ...
  def self.vips_cache_drop_all(*arg0); end
  def self.vips_cache_get_max(*arg0); end
  def self.vips_cache_get_max_files(*arg0); end
  def self.vips_cache_get_max_mem(*arg0); end
  def self.vips_cache_operation_build(*arg0); end
  def self.vips_cache_print(*arg0); end
  ...
  def self.vips_concurrency_get(*arg0); end
  ...
  def self.vips_image_invalidate_all(*arg0); end
  ...
  def self.vips_tracked_get_allocs(*arg0); end
  def self.vips_tracked_get_files(*arg0); end
  def self.vips_tracked_get_mem(*arg0); end
  def self.vips_tracked_get_mem_highwater(*arg0); end
  ...
  def self.vips_vector_isenabled(*arg0); end
  ...
  def vips_cache_drop_all(*arg0); end
  def vips_cache_get_max(*arg0); end
  def vips_cache_get_max_files(*arg0); end
  def vips_cache_get_max_mem(*arg0); end
  def vips_cache_operation_build(*arg0); end
  def vips_cache_print(*arg0); end
  ...
  def vips_concurrency_get(*arg0); end
  ...
  def vips_image_invalidate_all(*arg0); end
  ...
  def vips_tracked_get_allocs(*arg0); end
  def vips_tracked_get_files(*arg0); end
  def vips_tracked_get_mem(*arg0); end
  def vips_tracked_get_mem_highwater(*arg0); end
  ...
  def vips_vector_isenabled(*arg0); end
