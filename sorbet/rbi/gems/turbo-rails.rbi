...
module Turbo::Broadcastable
  ...
  def broadcast_after_to(*streamables, target: nil, targets: nil, **rendering); end
  ...
  def broadcast_before_to(*streamables, target: nil, targets: nil, **rendering); end
  ...
  def broadcast_remove_to(*streamables, target: nil, **rendering); end
  ...
  def extract_options_and_add_target(rendering = nil, target: nil); end
  extend ActiveSupport::Concern
end
...
class Turbo::Streams::TagBuilder
  def action(name, target, content = nil, method: nil, allow_inferred_rendering: nil, **rendering, &block); end
  def action_all(name, targets, content = nil, method: nil, allow_inferred_rendering: nil, **rendering, &block); end
  ...
  def replace(target, content = nil, method: nil, **rendering, &block); end
  def replace_all(targets, content = nil, method: nil, **rendering, &block); end
  def update(target, content = nil, method: nil, **rendering, &block); end
  def update_all(targets, content = nil, method: nil, **rendering, &block); end
  include Turbo::Streams::ActionHelper
end
