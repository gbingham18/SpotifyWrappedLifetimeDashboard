...
module Zip
  ...
  def reset!; end
  def self.warn_about_v3_api(method); end
  def setup; end
...
class Zip::Entry
  ...
  def extract_v3(entry_path = nil, destination_directory: nil, &block); end
  def file?; end
  ...
  def incomplete?; end
  def initialize(zipfile = nil, name = nil, *args); end
...
class Zip::File < Zip::CentralDirectory
  ...
  def extract_v3(entry, entry_path = nil, destination_directory: nil, &block); end
  def find_entry(entry_name); end
  def get_entry(entry); end
  def get_input_stream(entry, &a_proc); end
  def get_output_stream(entry, dep_permission_int = nil, dep_comment = nil, dep_extra = nil, dep_compressed_size = nil, dep_crc = nil, dep_compression_method = nil, dep_size = nil, dep_time = nil, permission_int: nil, comment: nil, extra: nil, compressed_size: nil, crc: nil, compression_method: nil, size: nil, time: nil, &a_proc); end
  def glob(*args, &block); end
  def initialize(path_or_io, dep_create = nil, dep_buffer = nil, create: nil, buffer: nil, **options); end
  ...
  def self.open(file_name, dep_create = nil, create: nil, **options); end
  def self.open_buffer(io, **options); end
  ...
  def self.split(zip_file_name, dep_segment_size = nil, dep_delete_zip_file = nil, dep_partial_zip_file_name = nil, segment_size: nil, delete_zip_file: nil, partial_zip_file_name: nil); end
  def to_s; end
...
class Zip::InputStream
  ...
  def initialize(context, dep_offset = nil, dep_decrypter = nil, offset: nil, decrypter: nil); end
  def input_finished?; end
  def open_entry; end
  def produce_input; end
  def rewind; end
  def self.open(filename_or_io, dep_offset = nil, dep_decrypter = nil, offset: nil, decrypter: nil); end
...
class Zip::OutputStream
  ...
  def initialize(file_name, dep_stream = nil, dep_encrypter = nil, stream: nil, encrypter: nil); end
  def put_next_entry(entry_name, comment = nil, extra = nil, compression_method = nil, level = nil); end
  def self.open(file_name, dep_encrypter = nil, encrypter: nil); end
  def self.write_buffer(io = nil, dep_encrypter = nil, encrypter: nil); end
