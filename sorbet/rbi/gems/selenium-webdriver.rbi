...
module Selenium::WebDriver::PointerActions
  def button_action(button, action, device: nil, **opts); end
  ...
  def move_by(right_by, down_by, device: nil, duration: nil, **opts); end
  def move_to(element, right_by = nil, down_by = nil, **opts); end
  def move_to_location(x, y, device: nil, duration: nil, **opts); end
  def pointer_down(button = nil, device: nil, **opts); end
  def pointer_input(name = nil); end
  def pointer_up(button = nil, device: nil, **opts); end
...
class Selenium::WebDriver::Interactions::PointerInput < Selenium::WebDriver::Interactions::InputDevice
  ...
  def create_pointer_move(duration: nil, x: nil, y: nil, origin: nil, **opts); end
...
class Selenium::WebDriver::Script
  def add_console_message_handler(&); end
  def add_javascript_error_handler(&); end
  def initialize(bridge); end
...
class Selenium::WebDriver::Network
  def add_authentication_handler(username, password); end
  def add_request_handler; end
  def callbacks; end
