...
class Arel::Attributes::Attribute < Anonymous_Struct_24
  def able_to_type_cast?; end
  def lower; end
...
class Arel::Visitors::Dot::Edge < Anonymous_Struct_25
end
...
class ActiveRecord::Type::Time::Value < Anonymous_Delegator_26
end
...
class ActiveRecord::Type::Serialized < Anonymous_Delegator_27
  def accessor; end
...
class ActiveRecord::Core::InspectionMask < Anonymous_Delegator_28
  def pretty_print(pp); end
end
...
class ActiveRecord::Locking::LockingType < Anonymous_Delegator_29
  def deserialize(value); end
  def encode_with(coder); end
  def init_with(coder); end
...
class ActiveRecord::AttributeMethods::TimeZoneConversion::TimeZoneConverter < Anonymous_Delegator_30
  def ==(other); end
  def cast(value); end
...
class ActiveRecord::Normalization::NormalizedValueType < Anonymous_Delegator_31
  def ==(other); end
  def cast(value); end
  def cast_type; end
  def eql?(other); end
...
class ActiveRecord::ConnectionAdapters::SQLite3::Column < ActiveRecord::ConnectionAdapters::Column
  ...
  def hash; end
  def init_with(coder); end
  def initialize(*, auto_increment: nil, rowid: nil, generated_type: nil, **); end
  def rowid; end
  def virtual?; end
...
module ActiveRecord::ConnectionAdapters::SQLite3::DatabaseStatements
  ...
  def begin_db_transaction; end
  def begin_deferred_transaction(isolation = nil); end
  def begin_isolated_db_transaction(isolation); end
  def build_truncate_statement(table_name); end
  ...
  def execute(*, **, &); end
  def execute_batch(statements, name = nil, **kwargs); end
  def explain(arel, binds = nil, _options = nil); end
  def high_precision_current_timestamp; end
  def internal_begin_transaction(mode, isolation); end
...
class ActiveRecord::ConnectionAdapters::SQLite3::TableDefinition < ActiveRecord::ConnectionAdapters::TableDefinition
  def belongs_to(*args, **options); end
  def change_column(column_name, type, **options); end
  def integer_like_primary_key_type(type, options); end
  def new_column_definition(name, type, **options); end
  def references(*args, **options); end
  def valid_column_definition_options; end
...
module ActiveRecord::ConnectionAdapters::SQLite3::SchemaStatements
  ...
  def indexes(table_name); end
  def is_column_the_rowid?(field, column_definitions); end
  ...
  def valid_table_definition_options; end
  def validate_index_length!(table_name, new_name, internal = nil); end
  def virtual_table_exists?(table_name); end
end
class ActiveRecord::ConnectionAdapters::SQLite3Adapter < ActiveRecord::ConnectionAdapters::AbstractAdapter
  ...
  def create_virtual_table(table_name, module_name, values); end
  def database_exists?; end
  def disable_referential_integrity; end
  def disconnect!; end
  def drop_virtual_table(table_name, module_name, values, **options); end
  def encoding; end
  ...
  def requires_reloading?; end
  def reset!(restore_transactions: nil); end
  def self.__class_attr_strict_strings_by_default; end
  def self.__class_attr_strict_strings_by_default=(new_value); end
  def self.dbconsole(config, options = nil); end
  def self.initialize_type_map(m); end
  def self.new_client(config); end
  def self.strict_strings_by_default; end
  def self.strict_strings_by_default=(value); end
  def self.strict_strings_by_default?; end
  def shared_cache?; end
  def strict_strings_by_default; end
  def strict_strings_by_default=(arg0); end
  def strict_strings_by_default?; end
  def supports_check_constraints?; end
  def supports_common_table_expressions?; end
  def supports_concurrent_connections?; end
  ...
  def table_structure_sql(table_name, column_names = nil); end
  def table_structure_with_collation(table_name, basic_structure); end
  def translate_exception(exception, message:, sql:, binds:); end
  def virtual_tables; end
  extend ActiveRecord::ConnectionAdapters::SQLite3::Quoting::ClassMethods
