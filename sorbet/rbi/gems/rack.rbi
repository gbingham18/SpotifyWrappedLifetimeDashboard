...
class Rack::Session::Cookie::SessionId < Anonymous_Delegator_17
  def cookie_value; end
...
class Rack::Directory::DirectoryBody < Anonymous_Struct_18
end
...
class Rack::Multipart::Parser::Collector::MimePart < Anonymous_Struct_19
end
