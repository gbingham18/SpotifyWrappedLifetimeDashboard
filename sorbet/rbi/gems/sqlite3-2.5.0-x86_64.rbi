...
#
#   https://github.com/sorbet/sorbet-typed/new/master?filename=lib/sqlite3-2.5.0-x86_64/all/sqlite3-2.5.0-x86_64.rbi
#
...
class SQLite3::Database
  ...
  def execute(sql, bind_vars = nil, &block); end
  def execute2(sql, *bind_vars); end
  def execute_batch(sql, bind_vars = nil); end
  ...
  def load_extension_internal(arg0); end
  def open16(arg0); end
  def open_v2(arg0, arg1, arg2); end
  def prepare(sql); end
  def query(sql, bind_vars = nil); end
  def readonly?; end
  ...
  def statement_timeout=(arg0); end
...
class SQLite3::Statement
  ...
  def prepare(arg0, arg1); end
  def remainder; end
  def reset!; end
  def sql; end
  def stat(key = nil); end
  def stat_for(arg0); end
