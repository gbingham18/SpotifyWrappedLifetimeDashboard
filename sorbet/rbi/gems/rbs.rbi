...
class RBS::EnvironmentLoader::Library < Anonymous_Struct_61
end
...
class RBS::DefinitionBuilder::MethodBuilder::Methods::Definition < Anonymous_Struct_62
end
...
class RBS::Prototype::RB::Context < Anonymous_Struct_63
end
